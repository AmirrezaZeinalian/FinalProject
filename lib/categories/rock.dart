...
class RockCategoryPage extends StatefulWidget {
  @override
  State<RockCategoryPage> createState() => _RockCategoryPageState();
}

class _RockCategoryPageState extends State<RockCategoryPage> {
          ...
          child: SingleChildScrollView(
            ...
            child: Obx(() => Column(
              ...
              children: [
                ...
                // Lock indicator widget added here
                Obx(() {
                  if (!_isSongPlayable(currentSongIndex.value)) {
                    return Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Locked - Purchase to play', style: TextStyle(color: Colors.red)),
                        ],
                      ),
                    );
                  }
                ...
                Obx(() => GestureDetector(
                  onTap: () {
                    ...
                    showLikeMessage(songs[currentSongIndex.value].isFavorite.value);
                  },
                  child: AnimatedSwitcher(
                    ...
                    child: Icon(
                      ...
                      key: ValueKey<bool>(songs[currentSongIndex.value].isFavorite.value),
                    ...
                    Obx(() => Row(
                      children: List.generate(5, (index) {
                        return IconButton(
                          ...
                          onPressed: () {
                            songs[currentSongIndex.value].rating.value = index + 1;
                          },
                        );
                      }),
                    )),
                        ...
                        children: [
                          ...
                          Obx(() => Row(
                            children: [
                              GestureDetector(
                                onTap: () {
                                  final isLiked = commentLikes[index].value;
                              ...
                              GestureDetector(
                                onTap: () {
                                  final isDisliked = commentDislikes[index].value;
                                  commentDislikes[index].value = !isDisliked;
                                  if (!isDisliked) {

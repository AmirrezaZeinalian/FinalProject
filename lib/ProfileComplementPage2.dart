...
// ۱. inputDecoration:
//
// ساخت استایل یکسان برای فیلدهای ورودی (شامل آیکون، رنگ و حاشیه)
//
// ۲. submitProfile:
//
// ارسال اطلاعات پروفایل و انتقال به صفحه موفقیت در صورت معتبر بودن
//
// ۳. build (در هر دو کلاس):
//
...
// ۱. GetMaterialApp:
//
// پایه اصلی برنامه با پیکربندی GetX
//
// ۲. Form + TextFormField:
//
// فرم و فیلدهای ورودی با اعتبارسنجی
//
// ۳. Card:
//
// کارت‌های زیبا برای بخش‌های مختلف فرم
//
// ۴. LinearGradient:
//
// ایجاد دکمه با گرادیانت رنگی
//
// ۵. Get.to / Get.offAll:
//
// مدیریت ناوبری بین صفحات با انیمیشن
//
// نکات کلیدی:
// طراحی مدرن با رنگ‌های بنفش
//
// اعتبارسنجی تاریخ و شهر
//
// انتقال به صفحه اصلی پس از تکمیل پروفایل
//
// استفاده از GetX